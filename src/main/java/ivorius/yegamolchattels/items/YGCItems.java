...
public final class YGCItems
{
    ...
    public static void register(RegistryEvent.Register<Item> event)
    {
        ...
        registerItemBlock(registry, YGCBlocks.tikiTorch, new ItemTikiTorch(YGCBlocks.tikiTorch));
        ...
        registerItemBlock(registry, YGCBlocks.treasurePile);
        ...
        registerItemBlock(registry, YGCBlocks.grandfatherClock, new ItemGrandfatherClock(YGCBlocks.grandfatherClock));
        registerItemBlock(registry, YGCBlocks.weaponRack, new ItemWeaponRack(YGCBlocks.weaponRack));
